...
function renderListStudent(students) {
  ...
  for (let i = 0; i < students.length; i++) {
    ...
    <tr>
        ...
        <td>${students[i].gender === "boy" ? "Nam" : "Nữ"}</td>
        <td>${students[i].math_score}</td>
        <td>${students[i].english_score}</td>
        <td>${students[i].literature_score}</td>
        <td>${calAverageScore(
          students[i].math_score,
          students[i].english_score,
          students[i].literature_score
        )}</td>
        <td>
